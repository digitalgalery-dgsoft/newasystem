...
class ImportOfficialPrinciplesCommand extends Command
{
    ...
    public function handle()
    {
        ...
        if (Schema::hasTable('principles')) {
            ...
            // 4. Kosongkan data dummy di principles
            $this->info('Menghapus data dummy di tabel principles...');
            try {
                if ($driver === 'sqlite') {
  ...
  array (
    ...
    'parent_company' => 'PT ANUGRAH TALENTA BERKARYA',
            ...
            $totalInserted = DB::table('principles')->count();
            $this->info("Berhasil mengimpor {$totalInserted} data master prinsiple resmi!");
