...
<div class="space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-xs text-slate-500 mt-1">
                    Direktori lengkap rekanan kerja sama prinsiple dan pengelompokan afiliasi ke 4 entitas inhouse (Arina, Alva, Anugrah, Abadi).
                </p>
            </div>
        </div>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
        ...
        <div class="stat-box">
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Entitas Inhouse</div>
                    <div class="text-2xl font-black text-primary mt-1">{{ $stats['parents'] }}</div>
                    <div class="text-[10px] text-slate-500 font-medium mt-0.5">Arina, Alva, Anugrah, Abadi</div>
                </div>
                ...
                <tbody class="divide-y divide-slate-100">
                    @forelse($principles as $index => $prin)
                        <tr class="hover:bg-slate-50/80 transition-colors">
                            ...
                            <td>
                                <span class="badge-pill bg-purple-50 text-purple-700 border-purple-200 font-semibold">
                                    <i class="fa-solid fa-network-wired text-[9px]"></i> {{ $prin->parent_company ?? 'Inhouse' }}
                                </span>
                            </td>
                            <td>
    ...
    <div class="bg-white rounded-2xl max-w-lg w-full shadow-2xl border border-slate-200 overflow-hidden">
        ...
        <form action="{{ route('master.prinsiple.store') }}" method="POST" class="p-6 space-y-4">
            ...
            <div>
                ...
                <input type="text" name="code" required placeholder="Contoh: PRN-011" class="w-full px-3 py-2 text-xs rounded-xl border border-slate-200 focus:ring-2 focus:ring-purple-600 bg-slate-50/50 font-mono">
            </div>

            <div>
                <label class="block text-xs font-bold text-slate-700 mb-1">Nama Prinsiple <span class="text-rose-500">*</span></label>
                <input type="text" name="name" required placeholder="Contoh: PT Samsung Electronics Indonesia" class="w-full px-3 py-2 text-xs rounded-xl border border-slate-200 focus:ring-2 focus:ring-purple-600 bg-slate-50/50">
            </div>

            <div>
                <label class="block text-xs font-bold text-slate-700 mb-1">Inhouse / Induk <span class="text-rose-500">*</span></label>
                <select name="parent_company" required class="w-full px-3 py-2 text-xs rounded-xl border border-slate-200 focus:ring-2 focus:ring-purple-600 bg-slate-50/50">
                    <option value="" disabled selected>Pilih Inhouse</option>
                    <option value="PT Arina Multi Karya">PT Arina Multi Karya</option>
                    <option value="PT Alva Karya Perkasa">PT Alva Karya Perkasa</option>
                    <option value="PT Anugrah Terpercaya Kerja">PT Anugrah Terpercaya Kerja</option>
                    <option value="PT Abadi Berkat Odelia">PT Abadi Berkat Odelia</option>
                </select>
            </div>
...
<div id="editPrincipleModal" class="fixed inset-0 z-50 hidden bg-slate-900/50 backdrop-blur-sm flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl max-w-lg w-full shadow-2xl border border-slate-200 overflow-hidden">
        ...
        <form id="editPrincipleForm" method="POST" class="p-6 space-y-4">
            ...
            <div>
                <label class="block text-xs font-bold text-slate-700 mb-1">Inhouse / Induk</label>
...
<script>
    ...
    function editPrinciple(prin) {
        ...
        document.getElementById('edit_parent_company').value = prin.parent_company;
