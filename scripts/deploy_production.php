...
$cmd = "--version && cd /www/wwwroot/new.asystem.co.id && git fetch origin main && git reset --hard origin/main && php artisan migrate --force && php artisan storage:link && php artisan optimize:clear && git log -1 --oneline";
